...
- ```Wireshark``` equivalent of ```airodump-ng```
...
root@kali:~/Desktop# airdecap-ng -w aa:bb:cc:dd:ee encrypted_packets.pcap 
Total number of packets read            27
...
root@kali:~/Desktop# ls -la encrypted_packets*
-rw-r--r-- 1 root root   24 Jun  6 16:22 encrypted_packets-dec.pcap
-rw-r--r-- 1 root root 3966 Jun  6 16:06 encrypted_packets.pcap
root@kali:~/Desktop# 
```
